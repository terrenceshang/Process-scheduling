...
public class ProcessGenerator {
     ...
     */
    public ProcessGenerator(String name, CPUGenerator cpuGen, IOGenerator ioGen, int numInstructions) {
    ...
    public static void main(String args[]) {
        try {
            ...
            final ProcessGenerator progGen = new ProcessGenerator(name, cpuGen, ioGen, length);
